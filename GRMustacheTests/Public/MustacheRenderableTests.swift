...
//        }
//        var error: NSError?
//        let rendering = Template(string: "{{.}}")!.render(Box(renderable), error: &error)
...
//            return Rendering("")
//        }
//        Template(string: "{{.}}")!.render(Box(renderable))
...
//            return Rendering("")
//        }
//        Template(string: "{{#.}}{{subject}}{{/.}}")!.render(Box(renderable))
...
//        
//        let renderableValue = Box({ (info: RenderingInfo, error: NSErrorPointer) -> Rendering? in
//            let altTemplate = Template(string: "{{{ value }}}")!
//            return altTemplate.render(info, error: error)
//        })
//        let value = Box([
...
//        }
//        let renderables = [Box(renderable1), Box(renderable2), Box(true), Box(false)]
