...
class NSFormatterTests: XCTestCase {
    ...
    func testFormatterIsAFilterForProcessableValues() {
        ...
        let value = Box(["number": Box(0.5), "percent": Box(percentFormatter)])
    ...
    func testFormatterIsAFilterForUnprocessableValues() {
        ...
        let value = Box(["string": Box("foo"), "percent": Box(percentFormatter)] as [String: Box])
        let rendering = template.render(value)!
    ...
    func testFormatterSectionDoesNotFormatUnprocessableInnerVariableTags() {
        ...
        let value = Box(["value": Box("foo"), "percent": Box(percentFormatter)] as [String: Box])
        let rendering = template.render(value)!
    ...
    func testFormatterAsSectionDoesNotFormatInnerSectionTags() {
        ...
        let value = Box(["number": Box(0.5), "NO": Box(0), "percent": Box(percentFormatter)] as [String: Box])
        let rendering = template.render(value)!
    ...
    func testFormatterIsTruthy() {
        ...
        let value = Box(["formatter": Box(formatter)])
        let rendering = template.render(value)!
    ...
    func testNumberFormatterRendersNothingForMissingValue() {
        ...
        let value = Box(["format": Box(percentFormatter)])
    ...
    func testNumberFormatterRendersNothingForNSNull() {
        ...
        let value = Box(["format": Box(percentFormatter), "value": Box(NSNull())])
    ...
    func testNumberFormatterRendersNothingForNSString() {
        ...
        var value = Box(["format": Box(percentFormatter), "value": Box("1")])
        ...
        value = Box(["format": Box(percentFormatter), "value": Box("YES")])
        ...
        value = Box(["format": Box(percentFormatter), "value": Box("foo")])
    ...
    func testNumberFormatterRendersNothingForNSDate() {
        ...
        let value = Box(["format": Box(percentFormatter), "value": Box(NSDate())])
    ...
    func testDateFormatterRendersNothingForMissingValue() {
        ...
        let value = Box(["format": Box(dateFormatter)])
    ...
    func testDateFormatterRendersNothingForNSNull() {
        ...
        let value = Box(["format": Box(dateFormatter), "value": Box(NSNull())])
    ...
    func testDateFormatterRendersNothingForNSString() {
        ...
        var value = Box(["format": Box(dateFormatter), "value": Box("1")])
        ...
        value = Box(["format": Box(dateFormatter), "value": Box("YES")])
        ...
        value = Box(["format": Box(dateFormatter), "value": Box("foo")])
    ...
    func testDateFormatterRendersNothingForNSNumber() {
        ...
        let value = Box(["format": Box(dateFormatter), "value": Box(0)])
